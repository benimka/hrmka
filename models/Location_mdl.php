...
class Location_mdl extends CI_Model{
    ...
    public function save($item){
      $this->db->insert('mod_location',$item);
    }


    public function delete($id){
	    $this->db->query("DELETE  FROM mod_location WHERE type_id='$id'");
    }
    ...
    public function edit($primary,$data)
    {
        ...
        $this->db->update('mod_location',$data);
    }
    ...
    public function actions()
    {
        if($this->session->userdata('logged_in'))
        {
            ...
            $query    = "SELECT sys_users.name, sys_module.module_name, sys_module.module_path, sys_module.slug, sys_module.module_level, sys_module.module_parent,
                        ...
                        where sys_users.user_id='$kode' AND sys_module.module_level ='3' AND sys_module.module_parent='67' ORDER BY sys_module.module_order ASC ";
