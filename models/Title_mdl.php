...
class Title_mdl extends CI_Model{
    ...
    public function edit($primary,$item)
    {
        ...
        $this->db->update('mod_level',$item);
    }

    public function getdata()
    {
        $data       = array();
        $query      = "SELECT * FROM mod_level ";
    ...
    public function actions()
    {
        if($this->session->userdata('logged_in'))
        {
            ...
            $query    = "SELECT sys_users.name, sys_module.module_name, sys_module.module_path, sys_module.slug, sys_module.module_level, sys_module.module_parent,
                        ...
                        where sys_users.user_id='$kode' AND sys_module.module_level ='3' AND sys_module.module_parent='109' ORDER BY sys_module.module_order ASC ";
