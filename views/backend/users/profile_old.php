            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="d-block d-md-flex justify-content-between mt-4 mt-md-0">
                      ...
                      <div class="mt-4 py-2 border-top border-bottom">
                        ...
                        <?php }else{ ?>
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo base_url()?>dokumen/<?php echo $doc['file_documents']; ?>" target="_blank">Open file</a> </td>
                          </tr>
                            ...
                            <table class="table" id="example6">
                              ...
                              <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="<?php echo base_url()?>sertifikat/<?php echo $ser['filename']; ?>" target="_blank"><?php echo $ser['filename']; ?></a></td>
                                  </tr>
                                  <?php } ?>
                                </table>
                  ...
                  <form class="forms-sample" method="POST" action="<?php echo base_url(); ?>admin/profile/edit_employee">
