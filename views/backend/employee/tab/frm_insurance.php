            ...
            <div class="row">
              <div class="col-lg-12 grid-margin grid-margin-lg-0">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin grid-margin-lg-0">
                    <div class="card-body">
                      <a href="#" style="background-color:#fff;color:#4B49AC;border:1px solid #4B49AC; " class="btn btn-light mr-2" data-toggle="modal" data-target="#ADDinsurance">Add Insurance</a>
                        ...
                        <table class="table">
                            <thead>
                              <tr>
                                  ...
                                  <th width="5%">Date Oh Birth</th>
                                  <th width="5%">Maternit</th>
                                  <th>Edit</th>
                                  <th>Delete</th>
                                </tr>
                            </thead>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <a 
                                          ...
                                          data-toggle="modal" data-target="#UPDinsurance"
...
<!-- Start Document Modal -->
  <div class="modal fade" id="ADDinsurance" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="ADDinsurance">
 ...
 <!-- Start Edit Document Modal -->
  <div class="modal fade" id="UPDinsurance" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="UPDinsurance">
    <form id="submits">
      <div class="modal-content">
        <div class="modal-header">
          <input type="hidden" name="ids" value="1">
  ...
  <script>
     $(document).ready(function() {
         ...
         $('#UPDinsurance').on('show.bs.modal', function (event) { 
