                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:18px; line-height:20px; text-align:left; padding-bottom:10px;"><multiline><?php echo $company; ?></multiline></td>
                                  </tr>
                                </table>
                              </th>
                              ...
                              <th class="column" width="120" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td class="text-header right" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:16px; text-align:right;"><multiline><a href="#" target="_blank" class="link" style="color:#000001; text-decoration:none;"><span class="link" style="color:#000001; text-decoration:none;">Date: <?php echo date('Y-m-d'); ?></span></a></multiline></td>
                                  </tr>
                                </table>
                              </th>
                            </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                          <tr>
                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:50px;text-align:center; padding-bottom:10px;"><multiline><?php echo $nama; ?> <br /></multiline></td>
                                </tr>
                                <tr>
                                  <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:26px; line-height:26px; text-align:center; color:#2e57ae; padding-top:30px;"><multiline><?php echo $judul; ?></multiline></td>
                                </tr>
                                <tr>
                                  <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:16px; line-height:20px; text-align:center; color:#2e57ae; padding-top:30px;"><multiline> Form&nbsp;&nbsp; <?php echo $date3; ?> &nbsp;&nbsp;To&nbsp;&nbsp; <?php echo $date4; ?> </multiline></td>
                                </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td class="p30-15" style="padding: 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td class="section-title pb30" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:14px; line-height:18px; text-align:justify; padding-bottom:30px;"><multiline><?php echo $pesan; ?></multiline></td>
                                </tr>
                                <tr>
                                  <td class="text-button" style="background:#ee817a; color:#ffffff; font-family:'Fira Mono', Arial,sans-serif; font-size:14px; line-height:18px;  padding-top:30px; text-align:center; padding:12px;border-radius: 25px;"><multiline><a href="<?php echo base_url('admin/leave_transaction/index?cd=');?><?php echo $id; ?>" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none;"><span class="link-white" style="color:#ffffff; text-decoration:none;"><?php echo $st; ?></span></a></multiline></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
