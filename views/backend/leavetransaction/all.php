                          ...
                          <div class="card-body">
                            <h6 class="card-title">&nbsp;Filter Status:</h6>
                              <select class="js-example-basic-single" style="color:#000;width:100%" id="select_leave">
                                ...
                                <option value="<?php echo base_url('admin/leave_transaction/all?query=0')?>">Pending</option>
                                <option value="<?php echo base_url('admin/leave_transaction/all?query=1')?>" <?php if($filter == 1){echo "selected='selected'";} ?>>Approved</option>
                                <option value="<?php echo base_url('admin/leave_transaction/all?query=6')?>" <?php if($filter == 6){echo "selected='selected'";} ?>>Not Approved</option>
                                <option value="<?php echo base_url('admin/leave_transaction/all?query=9')?>" <?php if($filter == 9){echo "selected='selected'";} ?>>Cancel</option>
                              </select>
