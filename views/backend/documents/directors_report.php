              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">Report Directors & Commissaris</h4>
                        ...
                        <div class="form-group row">
                          ...
                          <br>
                        <div class="input-group input-daterange d-flex align-items-center">
                          <button type="submit" class="btn btn-primary mr-2" id="directors_report">Proccess</button>
                          <a href="<?php echo base_url('admin/view/directors_report'); ?>" class="btn btn-light">Cancel</a>
                        </div>
                      </div>
                    </div>
                  </div>
