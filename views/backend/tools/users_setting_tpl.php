<div class="main-panel">
    <div class="content-wrapper"> <?php $this->apps->get_notification(); ?>
        <div class="row"> 
          <?php foreach ($setting_users as $key => $value) {
          # code...
          } ?>
              ...
              <div class="card">
                <div class="card-body"> <?php echo $value['role_id']; ?>
                  ...
                  <form method="POST" action="<?php echo site_url(); ?>admin/tools/create_users_login" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" name="user_name" value="<?php echo $value['email']; ?>">
