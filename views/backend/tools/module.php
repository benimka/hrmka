                      ...
                      <tbody>
                         <?php foreach ($getmodule as $key => $value) { ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url('admin/tools/settings'); ?>/<?php echo $value['role_id']; ?>" class="badge badge-info" style="background-color:#fff;color:#4B49AC;border:1px solid #4B49AC; ">setting</a>
                              </td>
                           </tr>
                         <?php } ?>
                      </tbody>
