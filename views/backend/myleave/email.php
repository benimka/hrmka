                          ...
                          <tr>
                            <td class="p30-15" style="padding: 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td class="text-button" style="background:#ee817a; color:#ffffff; font-family:'Fira Mono', Arial,sans-serif; font-size:14px; line-height:18px;  padding-top:30px; text-align:center; padding:12px;border-radius: 25px;"><multiline><a href="<?php echo base_url('admin/leave_transaction/index?cd=');?><?php echo $id; ?>" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none;"><span class="link-white" style="color:#ffffff; text-decoration:none;">Pending</span></a></multiline></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
