                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                         ...
                         <?php foreach ($report as $key => $users) { ?>
                              <?php if($users['mod_status_code'] == 'ST004'){?>
                              <tr style="background-color:red;">

                                   <td><?php echo $users['employee_code']; ?></td>

                                   <td><?php echo $users['number_contract']; ?></td>
                                   ...
                                   <td>Resign - (<?php echo $users['date_cut_off']; ?>)</td>
                            ...
                            <?php } elseif($users['mod_status_code'] == 'ST005') {?>
                              <tr style="background-color:yellow;">
                                   ...
                                   <td>Mutation - (<?php echo $users['date_cut_off']; ?>)</td>
