...
<script type="text/javascript">
   $("#proses").click(function(){  
        ...
        if (document.getElementById("jns1").checked == true) {
          ...
          var url      = "<?php echo base_url(); ?>admin/report/assets/rpt/?date1="+ date1 + "&date2=" + date2 + "&company_code=" + company_code;
                window.open(url,'_blank');

        } else {

          var url      = "<?php echo base_url(); ?>admin/report/assets/excel/?date1="+ date1 + "&date2=" + date2 + "&company_code=" + company_code;
                window.open(url,'_blank');
        }
