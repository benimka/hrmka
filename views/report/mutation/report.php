                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="input-group input-daterange d-flex align-items-center">
                          ...
                          <a href="<?php echo base_url('mkahrms/dashboard'); ?>" class="btn btn-light">Cancel</a>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
   $("#proses").click(function(){  
        ...
        if (document.getElementById("jns1").checked == true) {
          ...
          var url      = "<?php echo base_url(); ?>admin/report/mutation/rpt/?date1="+ date1 + "&date2=" + date2 + "&company_code=" + company_code;
                window.open(url,'_blank');

        } else {

          var url      = "<?php echo base_url(); ?>admin/report/mutation/excel/?date1="+ date1 + "&date2=" + date2 + "&company_code=" + company_code;
                window.open(url,'_blank');
        }
