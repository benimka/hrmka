                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                            <?php foreach ($report as $key => $users) { ?>
                                  ...
                                  <tr>
                                       <td><?php echo $users['insurance_name']; ?></td>

                                       <td><?php echo $users['membership']; ?></td>

                                       <td><?php echo "MAHAMERU KENCANA GROUP"; ?></td>

                                       <td><?php echo $users['company_name']; ?></td>

                                       <td><?php echo $users['date_of_birth']; ?></td>

                                       <td><?php  if($users['ins_sex']=="F"){echo "Female";}else{echo"Male";}; ?></td>
